...
const Dashboard: React.FC<DashboardInterface> = () => {
  return (
    <>
      <section className="header19 cid-tkzhQruteP" id="header19-p">
        <div className="mbr-overlay" style={{ opacity: 0.7, backgroundColor: 'rgb(9, 41, 46)' }}></div>
        <div className="container">
          <div className="col-md-12 align-center container-card">
            <div className="row justify-content-center">
              {ButtonsCards.map((card) => (
                <CardButtons key={card.title} {...card} />
              ))}
            </div>
          </div>
        </div>
